...
import com.stocksnap.di.AppModule_ProvideBackupManagerFactory;
import com.stocksnap.di.AppModule_ProvideDatabaseFactory;
import com.stocksnap.di.AppModule_ProvideDriveServiceFactory;
import com.stocksnap.di.AppModule_ProvideProductRepositoryFactory;
import com.stocksnap.di.AppModule_ProvideRestoreManagerFactory;
...
public final class DaggerStockSnapApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends StockSnapApplication_HiltComponents.ViewModelC {
    ...
    private SaveProductUseCase saveProductUseCase() {
      return new SaveProductUseCase(singletonCImpl.provideProductRepositoryProvider.get());
    }
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.reviewViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 3);
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return ImmutableMap.<String, Provider<ViewModel>>builderWithExpectedSize(6).put("com.stocksnap.presentation.dashboard.DashboardViewModel", ((Provider) dashboardViewModelProvider)).put("com.stocksnap.presentation.details.DetailsViewModel", ((Provider) detailsViewModelProvider)).put("com.stocksnap.presentation.history.HistoryViewModel", ((Provider) historyViewModelProvider)).put("com.stocksnap.presentation.review.ReviewViewModel", ((Provider) reviewViewModelProvider)).put("com.stocksnap.presentation.scan.ScanViewModel", ((Provider) scanViewModelProvider)).put("com.stocksnap.presentation.settings.SettingsViewModel", ((Provider) settingsViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.stocksnap.presentation.dashboard.DashboardViewModel 
          return (T) new DashboardViewModel(singletonCImpl.provideProductRepositoryProvider.get());

          case 1: // com.stocksnap.presentation.details.DetailsViewModel 
          return (T) new DetailsViewModel(viewModelCImpl.savedStateHandle, singletonCImpl.provideProductRepositoryProvider.get());

          case 2: // com.stocksnap.presentation.history.HistoryViewModel 
          return (T) new HistoryViewModel(singletonCImpl.provideProductRepositoryProvider.get());

          case 3: // com.stocksnap.presentation.review.ReviewViewModel 
          ...
          case 4: // com.stocksnap.presentation.scan.ScanViewModel 
          return (T) new ScanViewModel(viewModelCImpl.saveProductUseCase());

          case 5: // com.stocksnap.presentation.settings.SettingsViewModel 
          return (T) new SettingsViewModel(singletonCImpl.provideProductRepositoryProvider.get(), singletonCImpl.provideBackupManagerProvider.get(), singletonCImpl.provideRestoreManagerProvider.get(), singletonCImpl.provideDriveServiceProvider.get());
  ...
  private static final class SingletonCImpl extends StockSnapApplication_HiltComponents.SingletonC {
    ...
    private Provider<RestoreManager> provideRestoreManagerProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.mLKitProcessorProvider = DoubleCheck.provider(new SwitchingProvider<MLKitProcessor>(singletonCImpl, 2));
      this.provideDriveServiceProvider = DoubleCheck.provider(new SwitchingProvider<DriveService>(singletonCImpl, 4));
      this.provideBackupManagerProvider = DoubleCheck.provider(new SwitchingProvider<BackupManager>(singletonCImpl, 3));
      this.provideRestoreManagerProvider = DoubleCheck.provider(new SwitchingProvider<RestoreManager>(singletonCImpl, 5));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.stocksnap.data.repository.ProductRepository 
          return (T) AppModule_ProvideProductRepositoryFactory.provideProductRepository(singletonCImpl.provideDatabaseProvider.get());

          case 1: // com.stocksnap.data.database.AppDatabase 
          return (T) AppModule_ProvideDatabaseFactory.provideDatabase(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 2: // com.stocksnap.ocr.MLKitProcessor 
          ...
          case 3: // com.stocksnap.backup.BackupManager 
          return (T) AppModule_ProvideBackupManagerFactory.provideBackupManager(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.provideDatabaseProvider.get(), singletonCImpl.provideDriveServiceProvider.get());

          case 4: // com.stocksnap.backup.DriveService 
          return (T) AppModule_ProvideDriveServiceFactory.provideDriveService(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 5: // com.stocksnap.backup.RestoreManager 
          return (T) AppModule_ProvideRestoreManagerFactory.provideRestoreManager(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.provideDatabaseProvider.get(), singletonCImpl.provideDriveServiceProvider.get());
